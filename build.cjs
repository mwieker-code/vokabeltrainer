...
for(const dir of ['', 'year5','year6','year9','year10','oberstufe','oberstufe/analysis','all','all/analysis']){
...
console.log('Static build: nine pages, script syntax and local links checked.');
