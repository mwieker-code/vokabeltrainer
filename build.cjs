...
for(const item of ['index.html','manifest.webmanifest','year8','year5','year7','year6','year9','year10','oberstufe','bili','all','assets']){
...
console.log('Static build: fifteen pages, script syntax and local links checked.');
